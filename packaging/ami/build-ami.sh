#!/bin/bash -xe
# AMI Build Script - runs as user-data on EC2 instance
# Logs everything to /var/log/user-data.log and console
...
# Note: ami-files.tar.gz is at parent prefix level (without arch suffix)
echo "=== Downloading AMI build files ==="
S3_PARENT_PREFIX=$(dirname "${S3_PREFIX}")
