...
pub(crate) const JS_I18N_KEYS: &[&str] = &[
    ...
    "admin-js-edit-as-text-confirm",
    "admin-js-policy-history-note",
    "admin-js-preview-all",
    "admin-js-preview-count",
    "admin-js-preview-happened",
    "admin-js-preview-not-happened",
    "admin-js-preview-not-since",
