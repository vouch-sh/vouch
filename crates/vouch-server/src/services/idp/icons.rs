...
pub const GOOGLE: &str = concat!(
    r#"<svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">"#,
...
pub const MICROSOFT: &str = concat!(
    r#"<svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">"#,
...
pub const KEYCLOAK: &str = concat!(
    r#"<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">"#,
