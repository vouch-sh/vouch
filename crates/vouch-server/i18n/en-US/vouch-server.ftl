...
enroll-error-identity-conflict = Your identity provider returned a different user identifier than the one bound to this account. To protect the account, sign-in was refused. Please contact your administrator.
