...
admin-policies-rate-limit-desc = Denies issuance after 10 tokens in one hour, counted from this user's audit history
admin-policies-burst-desc = Denies issuance after 5 failed logins in ten minutes
admin-policies-stepup-desc = Token exchange (workload identity and agent credentials) requires a hardware login within the last 15 minutes
admin-policies-ipconsistency-desc = Token exchange must originate from the same IP address as a successful login in the last 8 hours
admin-policies-logoutinvalidates-desc = Token exchange is denied after logout until the user logs in again
