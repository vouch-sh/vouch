...
///
/// Returns `None` if the file doesn't exist or doesn't contain a valid cookie.
...
mod tests {
    ...
    fn test_netscape_format() {
        let cookie = SessionCookie::new("vouch.example.com", "token123", 1737849600);
        ...
        assert_eq!(parsed.expires, 1737849600);
